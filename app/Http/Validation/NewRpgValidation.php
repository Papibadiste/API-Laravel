...
class NewRpgValidation
{
    ...
    public function msg() {
        return [
            ...
            'description.min' => 'La description doit avoir 300 caractères minimum',
            'description.max' => 'La description doit avoir 330 caractères maximun',
            'src_img.required' => 'Une image est obligatoire',
